...
public enum CompatibleMaterial {
    ...
    ;
    private static HashMap<String, CompatibleMaterial> cachedSearch = new HashMap<>();
    String[] m;
    int data;

    CompatibleMaterial(int data, String... m) {
        this.m = m;
        this.data = data;
    }
    ...
    public static CompatibleMaterial requestXMaterial(String name, byte data) {
        if (cachedSearch.containsKey(name.toUpperCase() + "," + data)) {
            return cachedSearch.get(name.toUpperCase() + "," + data);
        }
        for (CompatibleMaterial mat : CompatibleMaterial.values()) {
    ...
    public static CompatibleMaterial fromString(String key) {
        CompatibleMaterial xmat;
        try {
            xmat = CompatibleMaterial.valueOf(key);
            return xmat;
    ...
    public CompatibleMaterial fromMaterial(Material mat) {
        try {
            return CompatibleMaterial.valueOf(mat.toString());
        } catch (IllegalArgumentException e) {
            for (CompatibleMaterial xmat : CompatibleMaterial.values()) {
    ...
    public boolean isDamageable(CompatibleMaterial type) {
