...
public enum CompatibleSound {
    ...
    CompatibleSound(String... versionDependentNames) {
     ...
     *
     * @return Returns the sound for this enum value if there is a valid sound for the current minecraft version, otherwise null
     */
     ...
     * Get the sound for this enum value and minecraft version
     *
     * @param def The value to return if no sound is found for this version
     * @return Returns the sound for this enum value if there is a valid sound for the current minecraft version, otherwise def
     */
    public Sound getSound(Sound def) {
        Sound sound = findSound();
        if (sound != null)
            return sound;
        else
            return def;
